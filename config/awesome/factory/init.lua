...
_factory.create_popup = function(obj)
	local popup = awful.popup({
		...
		ontop = true,
		minimum_height = dpi(obj.height) or dpi(100),
		maximum_height = dpi(obj.height) or dpi(100),
		minimum_width = dpi(obj.width) or dpi(400),
		maximum_width = dpi(obj.width) or dpi(400),
	})
...
_factory.create_button = function(obj)
	local button = wibox.widget({
		{
			...
			forced_height = obj.height or dpi(32),
			widget = wibox.container.place,
		},
		bg = obj.bg or beautiful.palette.transparent,
		fg = obj.fg or beautiful.palette.fg1,
	...
	button:connect_signal("mouse::enter", function(c)
		c:set_bg(obj.bg_hover or obj.bg or beautiful.palette.transparent)
		c:set_fg(obj.fg_hover or obj.fg or beautiful.palette.fg1)
	end)
	button:connect_signal("mouse::leave", function(c)
		c:set_bg(obj.bg or beautiful.palette.transparent)
		c:set_fg(obj.fg or beautiful.palette.fg1)
	end)
...
_factory.create_circular_progress = function(obj)
	obj = obj or {}
	...
	local circular_progress = wibox.widget({
		...
		forced_width = obj.radius and obj.radius * 2 or dpi(32),
		forced_height = obj.radius and obj.radius * 2 or dpi(32),
...
_factory.create_slider = function(obj)
	local slider = wibox.widget({
		...
		handle_color = beautiful.palette.accent,
